...
```html
max-[680px]:text-[clamp(2.2rem,11vw,3.5rem)]
...
grid grid-cols-2 gap-[clamp(2rem,6vw,5rem)]
```
...
<!-- After -->
<h1 class="font-[family-name:var(--font-display)] text-2xl">
```
...
<!-- After -->
<span class="text-[var(--clr-accent)]">
```
...
*Refactored on: 2026-03-25*  
*Commit: `refactor components to use tailwind v4 utilities`*
