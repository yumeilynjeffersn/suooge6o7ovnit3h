...
<section
	id="contacts"
	class="section contacts relative overflow-hidden bg-[var(--clr-surface)]"
	aria-labelledby="contacts-heading"
>
	<div
		class="container grid grid-cols-2 items-start gap-[clamp(2rem,6vw,5rem)] max-[900px]:grid-cols-1"
	>
		<div class="reveal">
			...
			<address>
				<ul class="flex flex-col gap-5" role="list">
					<li class="flex items-start gap-4">
						<span class="mt-0.5 flex-shrink-0 text-[1.3rem]" aria-hidden="true">📍</span>
						<div>
							<strong
								class="mb-1 block font-[family-name:var(--font-display)] text-[0.65rem] font-bold tracking-[0.1em] text-[var(--clr-accent)] uppercase"
					...
					<li class="flex items-start gap-4">
						<span class="mt-0.5 flex-shrink-0 text-[1.3rem]" aria-hidden="true">✉️</span>
						<div>
							<strong
								class="mb-1 block font-[family-name:var(--font-display)] text-[0.65rem] font-bold tracking-[0.1em] text-[var(--clr-accent)] uppercase"
		...
		>
			...
			<form novalidate aria-label={m.contacts_form_aria()}>
				<div class="mb-4 flex flex-col gap-2">
					<label
						for="name"
						class="font-[family-name:var(--font-display)] text-[0.62rem] font-bold tracking-[0.1em] text-[var(--clr-muted)] uppercase"
					...
					<input
						...
						autocomplete="name"
						required
						class="w-full resize-y rounded-[var(--radius)] border border-[var(--clr-border)] bg-[var(--clr-bg)] px-4 py-3 font-[family-name:var(--font-body)] text-[0.95rem] font-light text-[var(--clr-text)] placeholder:text-[var(--clr-muted)] focus:border-[var(--clr-accent)] focus:outline-none"
					/>
				</div>
				<div class="mb-4 flex flex-col gap-2">
					<label
				...
				<p class="mt-3 text-center text-xs text-[var(--clr-muted)]">
